 ...
 */
static const char *DEFAULT_WIN_BG     = "#121212";
static const char *DEFAULT_WIN_FG     = "#005faf";
static const char *DEFAULT_MARK_COLOR = NULL;  /* NULL means it will default to window foreground */
#if HAVE_LIBFONTS
static const char *DEFAULT_BAR_BG     = "#005faf";  /* NULL means it will default to window background */
static const char *DEFAULT_BAR_FG     = "#ffffff";  /* NULL means it will default to window foreground */
static const char *DEFAULT_FONT       = "JetBrains Mono:style=Regular:size=12";
